...
const BOAT_FIELDS = [BOAT_ID_FIELD, BOAT_NAME_FIELD, BOAT_DESCRIPTION_FIELD, BOAT_LENGTH_FIELD, BOAT_PRICE_FIELD, BOAT_TYPE_FIELD];
export default class BoatDetailTabs extends NavigationMixin(LightningElement) {
    ...
    get detailsTabIconName() {
        return this.wiredRecord.data !== null ? 'utility:anchor':null;
    }
